...
module.exports.addCourse =  async (req, res) => {
  const { coursename, description, price,willLearn, requirement,forWho,semester_id,images,videos ,meta_data } = req.body;
  try {
        const course = new Course({
          coursename: coursename,
          description: description||'Sorry we are updating this course\'s description',
          price: price,
          willLearn:willLearn||'Sorry beacause this course have a lot of things to learn, we are updating !',
          requirement:requirement||'For beginners that do not any knowledge about yoga',
...
module.exports.updateCourse = async (req, res) => {
  const fieldsToUpdate = ['coursename', 'description', 'price', 'willLearn', 'requirement', 'forWho', 'semester_id', 'images','status' ,'videos', 'meta_data'];
