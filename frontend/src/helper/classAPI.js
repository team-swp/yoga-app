...
export async function getClass() {
  return await getApi({
    apiPath: `/api/class/get`,
    errorMessage: "Cannot Get Class",
  });
}
...
export async function addClass(respone) {
  ...
  return await addApi(respone, {
    apiPath: `/api/class/add`,
    errorMessage: "Cannot Add Class",
  });
}
export async function updateClass(respone) {
  ...
  return await updateApi(respone, {
    apiPath: `/api/class/update`,
    errorMessage: "Cannot Update Class",
  });
}
