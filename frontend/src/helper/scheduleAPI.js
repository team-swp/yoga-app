...
export async function getSchedule() {
  return await getApi({
    apiPath: `/api/schedule/get`,
    errorMessage: "Cannot Get Schedule",
  });
}
...
export async function addSchedule(respone) {
  ...
  return await addApi(respone, {
    apiPath: `/api/schedule/add`,
    errorMessage: "Cannot Add Schedule",
  });
}
export async function updateSchedule(respone) {
  ...
  return await updateApi(respone, {
    apiPath: `/api/schedule/update`,
    errorMessage: "Cannot Update Schedule",
  });
}
