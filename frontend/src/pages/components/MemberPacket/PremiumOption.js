              ...
              paymentPromise.then((result) => {
                ...
                sendMail({
                  ...
                  text: `We are pleased to inform you that your payment (id; ${
                   ...
                   premium.premiumname
                  } package has been successfully processed, please go to yoga center to complete your payment. Thank you for your purchase and for choosing our services. If you have any questions or need further assistance, please don't hesitate to contact our support team.`,
                });
